...
export function StickyNav() {
  ...
  const desktopNav = (
    <nav
      className="glass backdrop-blur-md bg-background/70 pointer-events-auto flex w-full max-w-[min(100%,720px)] items-center gap-0.5 overflow-x-auto rounded-full px-1.5 py-1.5 hide-scrollbar sm:w-auto sm:gap-1"

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "KineTrace, movement health, stability score, balance test, fall prevention, phone sensor, movement tracking, health monitoring" },
      { property: "og:url", content: "https://kinetrace.netlify.app/" },
      { property: "og:image", content: "https://kinetrace.netlify.app/og-image.png" },
      { name: "twitter:title", content: "KineTrace — Understand Your Movement Health" },
      { name: "twitter:description", content: "Turn your phone into a movement health tracker. KineTrace gives you a simple stability score from your everyday movements — no special equipment needed." },
  ...
  const structuredData = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "Turn your phone into a movement health tracker. Get a simple stability score from your everyday movements.",
        "offers": {
          "@type": "Offer",
          "price": "0",
          "priceCurrency": "USD"
